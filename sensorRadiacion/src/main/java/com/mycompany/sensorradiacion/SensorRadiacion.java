...
public class SensorRadiacion {
    ...
    private static HiloSensadoRadia sensorActual = null;
...
public static void restablecerConexion() throws InterruptedException {
        ...
        while (intentos < MAX_INTENTOS_RECONEXION) {
            try {
                ...
                sensorActual = new HiloSensadoRadia(cliente, outToServer);
                sensorActual.start();
                ...
                if (intentos < MAX_INTENTOS_RECONEXION) {
                    ...
                    Logger.getLogger(HiloSensadoRadia.class.getName()).log(Level.SEVERE, 
