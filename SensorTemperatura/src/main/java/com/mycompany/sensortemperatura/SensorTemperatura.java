...
public class SensorTemperatura {
    ...
    private static HiloSensadoTemperatura sensorActual = null;
    ...
    public static void restablecerConexion() throws InterruptedException {
        ...
        while (intentos < MAX_INTENTOS_RECONEXION) {
            try {
                ...
                sensorActual = new HiloSensadoTemperatura(cliente, outToServer);
                sensorActual.start();
                ...
                if (intentos < MAX_INTENTOS_RECONEXION) {
                    ...
                    Logger.getLogger(HiloSensadoTemperatura.class.getName()).log(Level.SEVERE, 
