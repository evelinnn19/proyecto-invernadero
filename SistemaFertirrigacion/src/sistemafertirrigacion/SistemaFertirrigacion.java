...
public class SistemaFertirrigacion {
    ...
    private static HiloFertirrigacion hiloActual = null;
        ...
        while (sistemaActivo && intentos < MAX_INTENTOS_RECONEXION) {
            try {
                ...
                if (hiloActual != null && hiloActual.isAlive()) {
                    ...
                    hiloActual.detener();
                    hiloActual.join(2000);
                }
                
                // Crear y arrancar nuevo hilo
                hiloActual = new HiloFertirrigacion(cliente, outToServer);
                hiloActual.start();
                
                System.out.println("Reconexión exitosa. Sistema de Fertirrigación operativo.\n");
                return;
                ...
                Logger.getLogger(SistemaFertirrigacion.class.getName()).log(Level.WARNING, 
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("SISTEMA FERTIRRIGACIÓN - INICIANDO");
            ...
            try {
                ...
                Logger.getLogger(SistemaFertirrigacion.class.getName()).log(Level.SEVERE, null, e);
            }
